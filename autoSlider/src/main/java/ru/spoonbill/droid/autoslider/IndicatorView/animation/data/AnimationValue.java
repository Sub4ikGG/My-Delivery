package ru.spoonbill.droid.autoslider.IndicatorView.animation.data;

import androidx.annotation.NonNull;

import ru.spoonbill.droid.autoslider.IndicatorView.animation.data.type.ColorAnimationValue;
import ru.spoonbill.droid.autoslider.IndicatorView.animation.data.type.DropAnimationValue;
import ru.spoonbill.droid.autoslider.IndicatorView.animation.data.type.FillAnimationValue;
import ru.spoonbill.droid.autoslider.IndicatorView.animation.data.type.ScaleAnimationValue;
import ru.spoonbill.droid.autoslider.IndicatorView.animation.data.type.SwapAnimationValue;
import ru.spoonbill.droid.autoslider.IndicatorView.animation.data.type.ThinWormAnimationValue;
import ru.spoonbill.droid.autoslider.IndicatorView.animation.data.type.WormAnimationValue;
