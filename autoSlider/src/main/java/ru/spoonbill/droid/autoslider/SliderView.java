package ru.spoonbill.droid.autoslider;

import static ru.spoonbill.droid.autoslider.IndicatorView.draw.controller.AttributeController.getRtlMode;
...
import ru.spoonbill.droid.autoslider.IndicatorView.PageIndicatorView;
import ru.spoonbill.droid.autoslider.IndicatorView.animation.type.BaseAnimation;
import ru.spoonbill.droid.autoslider.IndicatorView.animation.type.ColorAnimation;
import ru.spoonbill.droid.autoslider.IndicatorView.animation.type.IndicatorAnimationType;
import ru.spoonbill.droid.autoslider.IndicatorView.draw.controller.DrawController;
import ru.spoonbill.droid.autoslider.IndicatorView.draw.data.Orientation;
import ru.spoonbill.droid.autoslider.IndicatorView.draw.data.RtlMode;
import ru.spoonbill.droid.autoslider.IndicatorView.utils.DensityUtils;
import ru.spoonbill.droid.autoslider.InfiniteAdapter.InfinitePagerAdapter;
import ru.spoonbill.droid.autoslider.Transformations.SimpleTransformation;
